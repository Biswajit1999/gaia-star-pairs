# Claude Code Task — Gaia Wide-Binary Astrometric Consistency Audit
...
5. Implement reusable scientific modules under `src/gaia_wide_binary_consistency_audit/`; notebooks must only orchestrate imported functions.
